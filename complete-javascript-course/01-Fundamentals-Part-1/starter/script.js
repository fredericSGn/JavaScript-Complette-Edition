...
let height = 0;
if (height) {
  console.log("YAY! Height ist defined");
} else {
...
//   console.log("Sahar is able to drive!");
// } else {
...
//Statements and Expressions Wyrażenie jest fragmentem kodu, który tworzy wartość, na przykład 3 + 4
...
//The Conditional(Ternary) Operator Trójskładnikowy operator if? else:
const age = 23;
// age >= 18
...
console.log(`I lide to drink ${drink}`);
